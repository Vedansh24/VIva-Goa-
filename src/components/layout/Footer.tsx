...
export default function Footer() {
  return (
    <footer id="contact" className="bg-[#05050a] border-t border-white/5 pt-20 pb-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 mb-16">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-amber-400 to-amber-600 rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/20 border border-white/10">
          ...
          <div className="flex flex-col">
            <h3 className="text-white/90 font-semibold text-sm uppercase tracking-widest mb-6">
              Contact Details
            </h3>
            <ul className="space-y-5">
              <li className="flex items-start gap-4 group">
                <div className="w-10 h-10 rounded-full bg-white/[0.03] flex items-center justify-center flex-shrink-0 group-hover:bg-amber-400/10 transition-colors border border-white/5 group-hover:border-amber-400/30">
                  <MapPin className="w-4 h-4 text-amber-400" />
                </div>
                <span className="text-white/60 text-sm leading-relaxed mt-2.5">
              ...
              <li className="flex items-center gap-4 group">
                ...
                <a href="tel:+917000608762" className="text-white/60 hover:text-amber-400 text-sm transition-colors mt-0.5">
                  +91 7000608762
                </a>
              </li>
              <li className="flex items-center gap-4 group">
                ...
                <a href="mailto:vivagoarealty@gmail.com" className="text-white/60 hover:text-amber-400 text-sm transition-colors mt-0.5">
          ...
          <div className="flex flex-col h-full min-h-[280px]">
            ...
            <div className="w-full flex-1 rounded-2xl overflow-hidden border border-white/10 relative group bg-white/5">
              {/* Subtle overlay to reduce map dominance, lifted on hover */}
              <div className="absolute inset-0 bg-[#05050a]/40 group-hover:bg-transparent transition-colors duration-500 pointer-events-none z-10" />
              <iframe
